...
type CREATE_USER_TYPE = typeof CREATE_USER_TYPE[keyof typeof CREATE_USER_TYPE];

export { PolymorphicTables, APPLY_SENDER_NOTICE, APPLY_REACTION, ROOM_TYPE, DISCONNECTED_REASON, CREATE_USER_TYPE };
